      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="card-hover bg-white rounded-2xl border border-slate-200 p-6 flex flex-col"
            >
              <span className="grid place-items-center w-12 h-12 rounded-xl bg-blue-50 text-[var(--blue)] mb-4">
                {service.icon}
              </span>
