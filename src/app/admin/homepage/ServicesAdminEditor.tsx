    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1 max-w-3xl">
            Konten card bisa diubah dari sini tanpa mengubah layout. Data disimpan ke Supabase. Jumlah card tetap 4,
            masing-masing card wajib punya 4 fitur, dan area gambar/icon di homepage tetap memakai ukuran yang sama.
          </p>
        </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
              ...
              <div className="p-5 sm:p-6 space-y-5">
                ...
                <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_280px]">
                  <div className="space-y-4">
                    <div>
                      <label className="block text-xs font-bold text-slate-500 mb-1.5">Path gambar</label>
                      <input
                        value={service.image}
                        ...
                        className="w-full h-11 rounded-xl border border-slate-200 px-3 text-sm text-slate-800 outline-none focus:border-[var(--blue)] focus:ring-2 focus:ring-[var(--blue)]/10 transition"
                      />
                      <p className="text-[11px] text-slate-400 mt-1.5">Kosongkan jika ingin pakai icon default. Gunakan path lokal seperti /images/namafile.png.</p>
                    </div>
                    <div>
        ...
        <aside className="space-y-5">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-5">
            <h3 className="font-head font-bold text-sm text-[var(--navy)]">Tips input gambar</h3>
            <ul className="mt-3 space-y-2 text-sm text-slate-600">
              <li>• Gunakan path seperti <code>/images/namafile.png</code>.</li>
              <li>• Simpan alt text singkat dan jelas.</li>
              <li>• Data editor ini sekarang disimpan di Supabase.</li>
            </ul>
          </div>
        </aside>
      </div>
