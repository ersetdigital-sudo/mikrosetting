    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href="/admin/homepage"
            className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold px-5 py-2.5 transition shadow-sm hover:border-blue-300 hover:text-[var(--blue)]"
          >
            Edit Homepage
          </Link>
          <Link
      ...
      <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--blue)]">Konten Homepage</p>
            <h2 className="font-head font-extrabold text-lg text-[var(--navy)] mt-1">Card layanan bisa diedit sendiri</h2>
            <p className="text-sm text-slate-500 mt-1 max-w-2xl">
              Edit badge, judul, deskripsi, gambar, dan 4 poin fitur untuk setiap card layanan tanpa mengubah layout homepage.
            </p>
          </div>
          <Link
            href="/admin/homepage"
            className="inline-flex items-center rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-bold text-white hover:bg-slate-700 transition"
          >
            Buka Editor Layanan
          </Link>
        </div>
