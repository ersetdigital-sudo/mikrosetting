...
function ArticleContent() {
  ...
  const topic = searchParams.get("topik") || "optimasi";
...
export default function ArticlePage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><p className="text-slate-500">Memuat artikel...</p></div>}>
      <ArticleContent />
    </Suspense>
  );
}
